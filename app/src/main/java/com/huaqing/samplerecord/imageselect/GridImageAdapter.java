package com.huaqing.samplerecord.imageselect;
...
public class GridImageAdapter extends RecyclerView.Adapter<GridImageAdapter.ViewHolder> {
    ...
    public void setList(List<LocalMedia> newList) {
    ...
    public void addList(List<LocalMedia> newList) {
            ...
            viewHolder.ll_del.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (index != RecyclerView.NO_POSITION) {
                        if (onItemImageDelClickListener != null) {
                            onItemImageDelClickListener.onDelClick(position, view);
                        }
                        list.remove(index);
...
//                            todo  加载图片也需要  baseurl
                            .load(BaseUrlManager.getInstance().getBaseUrl() + path)
                            .apply(options)
    ...
    private OnItemImageDelClickListener onItemImageDelClickListener;
    ...
    public interface OnItemImageDelClickListener {
        void onDelClick(int position, View v);
    }
    ...
    public void setOnImageDelClickListener(OnItemImageDelClickListener listener) {
        this.onItemImageDelClickListener = listener;
    }
