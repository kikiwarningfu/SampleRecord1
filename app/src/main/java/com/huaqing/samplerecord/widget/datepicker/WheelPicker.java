...
public class WheelPicker<T> extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        //中间的Item边框
        Log.e(TAG, "getPaddingLeft: +" + getPaddingLeft() + "top===" + mItemHeight * mHalfVisibleItemCount
                + "right===" + (getWidth() - getPaddingRight()) + "bottom===" + (mItemHeight + mItemHeight * mHalfVisibleItemCount));
