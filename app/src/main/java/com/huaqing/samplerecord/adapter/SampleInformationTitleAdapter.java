 ...
 * 水域环境列表 输入的标题的适配器
 */
public class SampleInformationTitleAdapter extends BaseQuickAdapter<SampleInformationListBean.DataBean.HeadDataBean, BaseViewHolder> {

    public SampleInformationTitleAdapter() {
        super(R.layout.item_sample_information_title);
    }

    @Override
    protected void convert(@NonNull @NotNull BaseViewHolder helper, SampleInformationListBean.DataBean.HeadDataBean item) {
