package com.huaqing.samplerecord.utlis.serice;
...
//
//			// 打印KeyStore信息
//			com.liuzy.tool.Util.show(keyStore, keyStorePwd);
//
//			return keyStore;
//		} catch (Exception e) {
...
//		}
	...
	public static KeyStore getTrustStoreByCrt(Context ctx, String crtFile) {
		...
		try {
			...
			// 打印KeyStore信息
//			com.liuzy.tool.Util.show(keyStore, null);
...
//			com.liuzy.tool.Util.show(keyStore, p12Pwd);
			return keyStore;
		} catch (Exception e) {
			Log.e(tag, "创建服务器信任的证书仓库失败");
			e.printStackTrace();
...
//			com.liuzy.tool.Util.show(keyStore, bksPwd);
			return keyStore;
			// 
		} catch (Exception e) {
			Log.e(tag, "创建客户端信任的服务器证书仓库失败");
