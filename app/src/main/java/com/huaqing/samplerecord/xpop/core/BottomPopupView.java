...
import com.huaqing.samplerecord.xpop.widget.SmartDragLayout;
...
public class BottomPopupView extends BasePopupView {
    ...
    protected void addInnerContent(){
        View contentView = LayoutInflater.from(getContext()).inflate(getImplLayoutId(),
                bottomPopupContainer, false);
    ...
    protected PopupAnimator getPopupAnimator() {
        ...
        if(translateAnimator==null) translateAnimator = new TranslateAnimator(getPopupContentView(),
