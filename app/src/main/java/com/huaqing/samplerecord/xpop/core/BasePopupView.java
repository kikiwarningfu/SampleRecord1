package com.huaqing.samplerecord.xpop.core;
...
import com.huaqing.samplerecord.xpop.XPopup;
import com.huaqing.samplerecord.xpop.animator.BlurAnimator;
import com.huaqing.samplerecord.xpop.animator.EmptyAnimator;
import com.huaqing.samplerecord.xpop.animator.PopupAnimator;
import com.huaqing.samplerecord.xpop.animator.ScaleAlphaAnimator;
import com.huaqing.samplerecord.xpop.animator.ScrollScaleAnimator;
import com.huaqing.samplerecord.xpop.animator.ShadowBgAnimator;
import com.huaqing.samplerecord.xpop.animator.TranslateAlphaAnimator;
import com.huaqing.samplerecord.xpop.animator.TranslateAnimator;
import com.huaqing.samplerecord.xpop.enums.PopupStatus;
import com.huaqing.samplerecord.xpop.impl.FullScreenPopupView;
import com.huaqing.samplerecord.xpop.impl.PartShadowPopupView;
import com.huaqing.samplerecord.xpop.util.KeyboardUtils;
import com.huaqing.samplerecord.xpop.util.XPopupUtils;

import java.util.ArrayList;
import java.util.List;

import static com.huaqing.samplerecord.xpop.enums.PopupAnimation.NoAnimation;
...
//                    addOnUnhandledKeyListener(et);
    ...
    protected boolean processKeyEvent(int keyCode, KeyEvent event){
        if (keyCode == KeyEvent.KEYCODE_BACK && event.getAction() == KeyEvent.ACTION_UP && popupInfo != null) {
            ...
            if (popupInfo.isDismissOnBackPressed &&
                    (popupInfo.xPopupCallback == null || !popupInfo.xPopupCallback
                            .onBackPressed(BasePopupView.this))) {
    ...
    protected PopupAnimator genAnimatorByPopupType() {
        ...
        switch (popupInfo.popupAnimation) {
            ...
            case ScaleAlphaFromRightBottom:
                return new ScaleAlphaAnimator(getPopupContentView(),
                        getAnimationDuration(), popupInfo.popupAnimation);

            case TranslateAlphaFromLeft:
            case TranslateAlphaFromTop:
            case TranslateAlphaFromRight:
            case TranslateAlphaFromBottom:
                return new TranslateAlphaAnimator(getPopupContentView(),
                        getAnimationDuration(), popupInfo.popupAnimation);
            ...
            case TranslateFromBottom:
                return new TranslateAnimator(getPopupContentView(),
                        getAnimationDuration(), popupInfo.popupAnimation);
            ...
            case ScrollAlphaFromLeftBottom:
                return new ScrollScaleAnimator(getPopupContentView(),
                        getAnimationDuration(), popupInfo.popupAnimation);
    ...
    public int getAnimationDuration() {
        ...
        return popupInfo.animationDuration >= 0 ? popupInfo.animationDuration
                : XPopup.getAnimationDuration() + 1;
    }

    public int getShadowBgColor() {
        return popupInfo != null && popupInfo.shadowBgColor != 0 ? popupInfo.shadowBgColor
                : XPopup.getShadowBgColor();
    }

    public int getStatusBarBgColor() {
        return popupInfo != null && popupInfo.statusBarBgColor != 0 ? popupInfo.statusBarBgColor
                : XPopup.getStatusBarBgColor();
    }
    ...
    protected void doAfterDismiss() {
        ...
        if (popupInfo != null && popupInfo.autoOpenSoftInput &&
                !(this instanceof PartShadowPopupView))
    ...
    protected void onDetachedFromWindow() {
        ...
        if (popupInfo != null) {
            if (getWindowDecorView() != null)
                KeyboardUtils.removeLayoutChangeListener(getHostWindow(),
                        BasePopupView.this);
    ...
    protected void passTouchThrough(MotionEvent event) {
        if (popupInfo != null && (popupInfo.isClickThrough || popupInfo.isTouchThrough) ) {
            if (popupInfo.isViewMode) {
                ...
                ViewGroup decorView = (ViewGroup) XPopupUtils.context2Activity(this)
        ...
        if (!XPopupUtils.isInRect(event.getX(), event.getY(), rect)) {
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_CANCEL:
                    ...
                    passTouchThrough(event);
                    if (distance < touchSlop && popupInfo != null
                            && popupInfo.isDismissOnTouchOutside) {
                        //查看是否在排除区域外
