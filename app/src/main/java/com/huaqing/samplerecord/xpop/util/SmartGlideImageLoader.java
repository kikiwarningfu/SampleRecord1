...
import com.huaqing.samplerecord.xpop.photoview.OnMatrixChangedListener;
...
//        downloadOnly()方法会返回一个FutureTarget对象，这个时候其实Glide已经开始在后台下载图片了，我们随时都可以调用
//        FutureTarget的get()方法来获取下载的图片文件，只不过如果图片还没下载好线程会暂时阻塞住，
//        等下载完成了才会把图片的File对象返回。
...
//        ssiv.setOrientation(SubsamplingScaleImageView.ORIENTATION_USE_EXIF);
        ssiv.setOnStateChangedListener(new SubsamplingScaleImageView.DefaultOnStateChangedListener() {
            ...
            public void onCenterChanged(PointF newCenter, int origin) {
                ...
                // 同步SubsamplingScaleImageView的滚动给snapshot
